          ...
          <div className="space-y-10 animate-fade-in">
            ...
            animationFillMode: 'both'
              ...
              <div className="space-y-2">
                <p className="text-lg font-medium tracking-wide text-gradient bg-gradient-to-r from-foreground to-muted-foreground bg-clip-text text-transparent">Hi there, I'm</p>
