        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center max-w-7xl mx-auto">
          ...
          <div className="space-y-10">
            ...
            <div className="space-y-6">
              ...
              <p className="text-xl text-muted-foreground leading-relaxed max-w-xl opacity-0 animate-[fade-in_1s_ease-out_0.8s_forwards]">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-6">
              <Button 
                ...
                className="group px-8 py-4 text-lg bg-primary hover:bg-primary/90 text-primary-foreground hover-glow transition-all duration-300 opacity-0 animate-[slide-in-right_0.8s_ease-out_2.2s_forwards,scale-in_0.6s_ease-out_2.2s_forwards] transform translate-x-8"
              >
              ...
              <Button 
                variant="outline" 
                size="lg" 
                className="glass-card px-8 py-4 text-lg border-primary/20 hover:border-primary/40 hover:bg-primary/10 transition-all duration-300 opacity-0 animate-[slide-in-right_0.8s_ease-out_2.4s_forwards,scale-in_0.6s_ease-out_2.4s_forwards] transform translate-x-8"
                onClick={() => {
            ...
            <div className="flex justify-center sm:justify-start pt-8">
              <button 
                ...
                className="flex flex-col items-center gap-2 text-muted-foreground hover:text-primary transition-colors group opacity-0 animate-[fade-in_0.8s_ease-out_2.8s_forwards,bounce_0.6s_ease-out_3s_forwards]"
              >
