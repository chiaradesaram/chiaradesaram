    ...
    <section className="relative min-h-screen overflow-hidden pt-32 pb-20 flex items-center">
      ...
      <div className="relative z-10 container mx-auto px-6 w-full">
        <div className="grid lg:grid-cols-2 gap-8 items-center max-w-7xl mx-auto">
          ...
          <div className="flex justify-center lg:justify-start lg:ml-16 relative opacity-0 animate-[fade-in_1s_ease-out_0.1s_forwards,scale-in_0.8s_ease-out_0.1s_forwards]">
