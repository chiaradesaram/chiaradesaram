...
const Testimonials = () => {
  const testimonials = [
    {
      id: 1,
      name: "Steve Gustavson",
      title: "Global Director of Product and Price Enablement, Wolters Kluwer",
      quote: "I had the pleasure of working with Chiara, and she consistently impressed me with her analytical approach to problem solving and her ability to deliver high-quality work on time. She has a natural talent for breaking down complex issues, identifying solutions, and executing them with precision. Beyond her technical strengths, Chiara brings a collaborative spirit to every project. Her approachable demeanor encourages open dialogue, making her a trusted partner across teams. Colleagues feel valued and heard when working with her, which elevates both individual contributions and collective results. She is a tremendous asset to any organization."
    },
    {
      id: 2,
