        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            {featuredProjects.map((project, index) => (
              <Card 
                key={project.id}
                className="group relative overflow-hidden border border-border bg-gradient-to-br from-card to-card/50 hover:from-card/80 hover:to-card/30 shadow-lg hover:shadow-xl transition-all duration-500 hover:-translate-y-2 rounded-xl"
                style={{
