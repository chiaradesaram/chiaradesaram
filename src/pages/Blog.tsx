...
const Blog = () => {
  ...
  return <div className="min-h-screen bg-background">
      ...
      <section className="pb-24 px-6">
        <div className="container mx-auto max-w-4xl">
          <div ref={blogRef} className={`transition-all duration-700 delay-200 ${blogVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            ...
            <div className="relative">
              ...
              <div className="space-y-12 max-w-2xl mx-auto opacity-30">
                {blogPosts.map((post, index) => <Card key={post.id} className="group sticky top-20 transform transition-all duration-300 ease-out overflow-hidden border border-border bg-card hover:bg-card/50 hover:border-primary/20 shadow-lg hover:shadow-xl" style={{
                zIndex: index + 1,
                    ...
                    <CardContent className="relative p-6 pt-0">
                      <div className="space-y-4">
                        ...
                        <div className="flex flex-wrap gap-2 mb-4">
                          {post.tags.map(tag => <Badge key={tag} variant="outline" className="text-xs px-3 py-1 bg-muted/50 text-muted-foreground border border-border hover:bg-muted hover:border-primary/40 transition-all duration-200">
                              {tag}
                            </Badge>)}
                        </div>
